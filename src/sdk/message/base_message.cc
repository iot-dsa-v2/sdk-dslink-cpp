...
namespace dsa {
Message::Message(const uint8_t* begin, const uint8_t* end) : static_headers(begin){};
...
RequestMessage::RequestMessage(const uint8_t* begin, const uint8_t* end) : Message(begin, end){};
...
ResponseMessage::ResponseMessage(const uint8_t* begin, const uint8_t* end)
    : Message(begin, end){};
