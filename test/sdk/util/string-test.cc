...
const string_ str = "! \"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~\xa2\xf7";
...
TEST(StringEncodeTest, EncodeFileName) {
  ...
  EXPECT_EQ(encode_str,
            "%21 \"#$%25&%27()%2A+,-.%2F0123456789%3A%3B%3C%3D%3E%3F@ABCDEFGHIJKLMNOPQRSTUVWXYZ[%5C]^_%60abcdefghijklmnopqrstuvwxyz{|}~%A2%F7");
  EXPECT_EQ(str, url_decode(encode_str));
}
