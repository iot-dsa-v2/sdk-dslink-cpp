...
TEST(MessageTest, HandshakeF0Constructor01) {
...
TEST(MessageTest, HandshakeF0GetResponseType) {
  HandshakeF0Message message;

  EXPECT_EQ(MessageType::INVALID, message.get_response_type(MessageType::HANDSHAKE0));
}
